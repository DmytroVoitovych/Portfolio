      ...
      <li key={index} css={(desctop || tablet || isMobile) && tabletka}>
        ...
        >
          <Details
            ...
            styleInfo={styleInfo}
            info={info}
            media={{ burger, isMobile, tablet, desctop }}
          />
          <picture
            onMouseEnter={() => {
              (desctop || all) && setHover(true);
              (desctop || all) && funcHover(hover, index);
            }}
            onTouchStart={() => {
              setInd(index);
            }}
          ...
          <div>
            <video
              ...
              onMouseLeave={() => {
                (desctop || all) && setHover(false);
                (desctop || all) && funcHover(hover, index);
              }}
              onTouchStart={() => {
                setHover(!hover);
                funcHover(true, index);
              }}
              id={index}
              autoPlay
              muted
